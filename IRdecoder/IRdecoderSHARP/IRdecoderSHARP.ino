//episode3: decoding various IR protocol: SHARP
...
const int code1a = 0x992B; //first code for continuous button
const int code1b = 0xB93A; //second code for continuous button
const int code2a = 0x30D5; //first code for non-continuous button
const int code2b = 0x1F22; //second code for non-continuous button
